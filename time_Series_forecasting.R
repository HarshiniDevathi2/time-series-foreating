...
saveWidget(as_widget(func_out[[1]][1][[1]]), "AutoARIMA_plot.html",selfcontained = F)
saveWidget(as_widget(func_out[[1]][2][[1]]), "GaussianProcessRegression_SE_plot.html",selfcontained = F)
saveWidget(as_widget(func_out[[1]][3][[1]]), "GaussianProcessRegression_Vanilladot_plot.html",selfcontained = F)
saveWidget(as_widget(func_out[[1]][4][[1]]), "Prophet_plot.html",selfcontained = F)
